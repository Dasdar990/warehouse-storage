  ...
  <section class="card">
    ...
    <div v-show="expanded" class="mb-3.5 flex flex-wrap items-center gap-2">
      <input
        ...
        class="field-input h-10 min-w-40 flex-1 basis-45 text-[0.82rem]"
      />
      <input
        v-model="operatorQuery"
        type="text"
        placeholder="Search by operator…"
        class="field-input h-10 min-w-36 flex-1 basis-40 text-[0.82rem]"
      />
      <select
        v-model="actionFilter"
        class="field-input h-10 min-w-32 flex-1 basis-32 text-[0.82rem]"
      >
      ...
      <select
        ...
        class="field-input h-10 min-w-32 flex-1 basis-36 text-[0.82rem]"
      >
    ...
    <template v-if="expanded">
      ...
      <div
        v-else
        class="scrollbar-slim max-h-200 overflow-y-auto overflow-x-auto pr-1"
      >
