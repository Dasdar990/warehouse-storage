...
class Movement(Base):
    ...
    timestamp = Column(DateTime(timezone=True), default=now_rome, nullable=False, index=True)
    ...
    split_from_item_id = Column(Integer, ForeignKey("items.id", ondelete="SET NULL"), nullable=True)
